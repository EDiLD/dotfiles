...
declare -r DOTFILES_TARBALL_URL="https://api.github.com/repos/$GITHUB_REPOSITORY/tarball/vm_work"
declare -r DOTFILES_UTILS_URL="https://raw.githubusercontent.com/$GITHUB_REPOSITORY/vm_work/src/os/utils.sh"
