...
cran_pkg <- c('ade4', 'agricolae',
              ...
              'pbapply',
              'pbkrtest', 'permute', 'plotly', 'plotrix', 'png', 'profr', 'purrr', 
              'quantreg', 'randomForest', 'raster', 'rcdk', 'R2admb',
              'Rcpp', 'RCurl', 'readxl', 'relaimpo', 'reshape2', 'ReporteRs', 
              'rgdal', 'rgeos', 'rgl', 'rgrass7', 'rjags', 'RJDBC', 
              'rJava', 'rmarkdown', 'roxygen2', 'RPostgreSQL', 'rpostgis', 'RSQLite', 
